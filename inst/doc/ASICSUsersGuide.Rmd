...
completely automated procedure to identify and quantify metabolites in $^1$H 
NMR spectra of biological mixtures. It will enable empowering NMR-based 
metabolomics by quickly and accurately helping experts to obtain metabolic 
profiles.
...
`ASICS_multiFiles` function, quantification is launched on all spectra 
present in the specified folder (`name.dir`). The arguments of this function are the 
...
Concordet, D., and Servien, R. (2017). ASICS: an automatic method for 
identification and quantification of metabolites in complex 1D 1H NMR spectra 
Metabolomics, 13: 109. https://doi.org/10.1007/s11306-017-1244-5
